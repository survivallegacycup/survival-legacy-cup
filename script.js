...
// ================= HỆ THỐNG MŨI TÊN CHUYỂN 3 TRANG =================
let trangHienTai = 1;
function chuyenTrang(huong) {
    trangHienTai += huong;
    if (trangHienTai > 3) trangHienTai = 1; // Nhảy từ trang 3 về trang 1
    if (trangHienTai < 1) trangHienTai = 3; // Lùi từ trang 1 xuống trang 3
