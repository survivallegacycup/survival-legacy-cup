...
/* ================= BÔI ĐEN XÓA HÀM CŨ VÀ DÁN HÀM NÀY VÀO ================= */
    ...
    try {
        ...
        for (let i = 0; i < rows.length; i += 4) {
            ...
            for (let j = 0; j < 4; j++) {
                ...
                // HÀNG ĐẦU TIÊN: Bơm 5 thông tin của Đội vào
                if (j === 0) {
                    container.innerHTML += `
                    ...
                    // CÁC HÀNG SAU: Phải bơm 5 ô trống vô hình để chống "trật khớp" lưới 8 cột
                    container.innerHTML += `
